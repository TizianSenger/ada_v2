...
const ToolsModule = ({
    ...
    return (
        <div
            ...
            className={`absolute px-6 py-3 transition-all duration-300
        ...
        >
            ...
            <div className="flex justify-center gap-6 relative z-10 animate-breathe">
                {/* Power Button */}
                <button
                    onClick={onTogglePower}
                    className={`p-3 rounded-full border-2 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 ${isConnected
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 ${isVideoOn
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 ${showSettings ? 'border-cyan-400 text-cyan-400 bg-cyan-900/20 shadow-[0_0_12px_rgba(34,211,238,0.3)]' : 'border-cyan-900 text-cyan-700 hover:border-cyan-500 hover:text-cyan-500'
                        } `}
                >
                    <Settings size={24} />
                </button>
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 ${isHandTrackingEnabled
                ...
                <button
                    ...
                    className={`p-3 rounded-full border-2 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 ${showQuotaWindow
